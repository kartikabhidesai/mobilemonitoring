...
class Utility {
    ...
    function sendNotification($deviceToken, $message , $extra) {

        $this->notificationForAndroid($deviceToken, $message , $extra);
    ...
    function notificationForAndroid($token, $msg , $extra) {
