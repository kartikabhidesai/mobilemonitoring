...
<div class="portlet light portlet-fit bordered">
    ...
    <div class="portlet-body">
        <div class="row">
            <!--<div class="col-md-3">-->
                <?php //echo userSidebar('gallary', $user_name, $user_id); ?>
            <!--</div>-->
            <div class="col-md-12">
                        ...
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Gallary</span>
                                </div>
                            </div>
                            <div class="portlet-body">
                                <div class="grid">
                                    ...
                                    <?php for($i=0; $i<count($gallaryData); $i++) { 
