                    ...
                    <div class="row">
                        <div class="portlet light">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-blue-madison bold uppercase">Video Recording List</span>
                                </div>
                            </div>
                            <div class="portlet-body">
					 ...
					 <?php
						...
						<video width="226" height="170" controls>
                                         <source src="<?php echo base_url().'public/upload/screen_videos/'.$videoData[$i]->video; ?>" type="video/mp4">
                                        </video> 
                                    </figure>
