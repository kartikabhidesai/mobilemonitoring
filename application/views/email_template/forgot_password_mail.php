<div style="width: 560px; margin: 0 auto; display: block; box-shadow: 0px 0px 14px 0px rgba(142, 140, 140, 0.67); background: #fff; padding: 48px;padding-top: 5px;">
    ...
    <h2 style="padding-bottom: 30px;text-align: center; display: block;font-family: sans-serif; margin:0 auto;">Forgot password</h2>
    <div style="background: linear-gradient(#fff,rgba(255, 66, 0, 0.16));
        ...
        <p style ="font-size:16px; font-family: sans-serif; margin-top:30px;line-height: 24px;">This email was sent automatically by <?php echo PROJECT_NAME; ?> in response to your request to reset your password</p>

        <p style ="font-size:16px;font-family: sans-serif;line-height: 24px;">To reset your password and access your account, click on bellow link to reset your password. This link is only valid for next 4 hrs.</p>

        <p style="font-size:16px; margin-top:40px;line-height: 24px;font-family: sans-serif;">
            <a href="<?php echo $link; ?>" style="padding: 10px 29px; border: 1px solid #ff4200;text-decoration: none;color: #fff; background: #ff4200; float: left;box-shadow: 2px 3px 5px 0px #7a7676;">Click here</a></p>
